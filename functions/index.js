...
document.write(
  "<h2> The Square Argument Of Number ",
  number,
  "<sup> 2 </sup>",
  " is ",
  Squares(number)
...
function factorial(num) {
  // ,Factorial means multiplying all the positive integers less than or equal to a given number until the value 1 is reached.. example 3 is given then 3 * 2 * 1 = 6 is a factorail number
  converttonum(num);
  if (num === 0) {
    return 1;
  } else {
